...
│   │   │   ├── layout.tsx               # Layout با سایدبار
│   │   │   ├── page.tsx                 # داشبورد ادمین
│   │   │   ├── users/                   # مدیریت کاربران
│   │   │   ├── communities/             # مدیریت کامیونیتی‌ها
...
│   │       ├── DataTable.tsx            # جدول داده با صفحه‌بندی
│   │       ├── SimpleLineChart.tsx      # نمودار خطی
│   │       ├── SimpleBarChart.tsx       # نمودار ستونی
│   │       ├── SimplePieChart.tsx       # نمودار دایره‌ای
...
دسترسی فقط برای کاربرانی که `is_admin=true` هستند.

#### داشبورد ادمین (`/admin`)
- آمار کلی: کاربران، کامیونیتی‌ها، کارت‌ها، پیام‌ها
- نمودار ثبت‌نام کاربران (خطی)
- نمودار کارت‌های جدید (ستونی)
- نمودار توزیع کاربران (دایره‌ای)
- رویدادهای اخیر سیستم

#### مدیریت کاربران (`/admin/users`)
- لیست کاربران با فیلتر و صفحه‌بندی
- جستجو بر اساس ایمیل/نام
- فیلتر: همه، فعال، بن‌شده، ادمین
- اکشن‌ها: بن/آن‌بن، تغییر وضعیت ادمین

#### مدیریت کامیونیتی‌ها (`/admin/communities`)
- لیست تمام کامیونیتی‌ها
- اطلاعات: نام، مالک، تعداد اعضا
- اکشن‌ها: فعال/غیرفعال کردن

#### مدیریت کارت‌ها (`/admin/cards`)
- لیست تمام کارت‌ها
- فیلتر: مسافر/فرستنده، فعال/غیرفعال
- اکشن‌ها: فعال/غیرفعال کردن

#### گزارش‌ها (`/admin/reports`)
- لیست گزارش‌های کاربران
- اطلاعات: گزارش‌دهنده، گزارش‌شده، متن
- اکشن‌ها: علامت‌گذاری به‌عنوان حل‌شده

#### لاگ‌ها (`/admin/logs`)
- لیست رویدادهای سیستم
- فیلتر بر اساس نوع رویداد
- اطلاعات: کاربر، نوع، IP، زمان
