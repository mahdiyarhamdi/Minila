        ...
        <div className="py-10 sm:py-12 lg:py-16">
          ...
          <div className="text-center sm:text-start mb-10 sm:mb-12">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 mb-6">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-neutral-400 hover:bg-neutral-700 hover:text-white transition-colors"
                aria-label="LinkedIn"
              >
