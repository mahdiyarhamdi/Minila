...
- 📧 سیستم ایمیل هوشمند با پشتیبانی SendGrid
- 🌍 قالب‌های ایمیل چندزبانه (فارسی، انگلیسی، عربی)
...
- 👤 فیلد `preferred_language` برای ذخیره زبان ترجیحی کاربر
...
- `membership_request`: درخواست عضویت جدید
